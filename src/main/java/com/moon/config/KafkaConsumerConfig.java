...
/**
 * Created by Moon on 6/07/2021
 */
@EnableKafka // this annotation is required on the configuration class to enable detection of @KafkaListener annotation on spring-managed beans:
@Configuration
